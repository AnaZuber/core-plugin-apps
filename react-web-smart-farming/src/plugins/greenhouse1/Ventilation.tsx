...
export const Ventilation: FC<Props> = () => {
  ...
  var Icon = IconRegistry['ventilation'];
  const onPowerChange = (on: boolean) => {
    setOn(!on);
  }

  return (
    <PluginContainer title='Turn on ventilation in greenhouse 1' subtitle={`Current: ${on ? 'ON' : 'OFF'}`} justifyContent="space-between">
