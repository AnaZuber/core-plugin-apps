...
import { HorizontalContainer, IconRegistry, VerticalContainer } from "../../components";
...
export const Temperature: FC<Props> = () => {
  ...
  return (
    <PluginContainer title='Turn on heating on salads in greenhouse 1' subtitle={`Heating: ${on ? 'ON' : 'OFF'}`} justifyContent="space-between">
