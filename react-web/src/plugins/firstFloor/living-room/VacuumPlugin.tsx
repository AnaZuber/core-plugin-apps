...
export const VacuumPlugin: FC<Props> = () => {
  ...
  var Icon = IconRegistry['vacuumIcon'];
  ...
  return (
    <PluginContainer title='Turn on the vacuum in living room' subtitle={`Power: ${on ? 'ON' : 'OFF'}`} justifyContent="space-between">
